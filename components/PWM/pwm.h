...
#define GPIO_AIN2                17   // AIN2 连接 ESP32-S3 的 GPIO
#define GPIO_PWMA                9   // PWMA 连接 ESP32-S3 的 GPIO
#define GPIO_BIN1                21   // BIN1 连接 ESP32-S3 的 GPIO
#define GPIO_BIN2                47   // BIN2 连接 ESP32-S3 的 GPIO
...
#define PWMB_CHANNEL             LEDC_CHANNEL_3        // 使用LEDC通道1
#define PWMB_MODE                LEDC_LOW_SPEED_MODE   // 低速模式（对于电机控制足够）
#define LEDC_DUTY_RES            LEDC_TIMER_13_BIT     // PWM占空比分辨率设为13位 (0-8191)
#define LEDC_FREQUENCY           (5000)                // PWM频率设为5kHz
